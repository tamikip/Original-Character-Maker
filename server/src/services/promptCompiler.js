...
function createDefaultExpressionPrompts() {
  return _expressionPrompts || {
    thinking:
      "严格保持参考图里角色的特征，同时角色的姿势不变，只把表情调整成思考状态。画面中只有这一个人物，禁止出现其他人物、物体、文字、边框或装饰。背景必须纯白色，无渐变无纹理。输出尺寸 1024x1024 像素。",
    surprise:
      "严格保持参考图里角色的特征，同时角色的姿势不变，只把表情调整成惊讶状态。画面中只有这一个人物，禁止出现其他人物、物体、文字、边框或装饰。背景必须纯白色，无渐变无纹理。输出尺寸 1024x1024 像素。",
    angry:
      "严格保持参考图里角色的特征，同时角色的姿势不变，只把表情调整成微微生气的状态。画面中只有这一个人物，禁止出现其他人物、物体、文字、边框或装饰。背景必须纯白色，无渐变无纹理。输出尺寸 1024x1024 像素。"
  };
}
